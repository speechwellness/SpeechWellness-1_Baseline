...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="facebook/wav2vec2-large-xlsr-53")
    parser.add_argument("--audio_path", type=str, default="./data")
    parser.add_argument("--segment_path", type=str, default="./transcriptions")
    parser.add_argument("--task", type=str, default="0", choices=["0", "1", "2", "all"])
    parser.add_argument("--remove_silence", action="store_true", help="Whether to remove silence between segments")
    ...
    parser.add_argument("--output_dir", type=str, default="results/task0/xlsr53")
...
def main():
    ...
    os.system("cp {} {}".format("script/audio/audio_train.py", os.path.join(args.output_dir, "train.py")))
    os.system("cp {} {}".format("script/audio/audio_model.py", os.path.join(args.output_dir, "model.py")))

    feature_extractor = AutoFeatureExtractor.from_pretrained(args.model_path)
    train_dataset = AudioDataset(args.train_json, feature_extractor=feature_extractor, args=args)
    dev_dataset = AudioDataset(args.dev_json, feature_extractor=feature_extractor, args=args)
